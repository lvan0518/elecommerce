<template>
        ...
        <el-card>
            ...
            <el-table :data="userList" border stripe>
                ...
                <el-table-column label="邮箱"
                                 ...
                                 header-align="center"
                ></el-table-column>
                <el-table-column label="电话" prop="mobile" align="center" header-align="center"
                ></el-table-column>
                <el-table-column label="角色" prop="role_name" align="center" header-align="center"
                ></el-table-column>
                ...
                <el-table-column label="操作" prop="" align="center" header-align="center" width="180px"
                >
                    <template slot-scope="scope">
                        <!--修改按钮-->
    ...
    <el-button type="primary" @click="editUserInfo">确 定</el-button>
        ...
        <el-dialog
                ...
                width="50%"
                @close="setRolesDialog"
                :before-close="handleClose">
           <div>
               <p>当前用户：{{userInfo.username}}</p>
               <p>当前角色: {{userInfo.role_name}}</p>
               <p>分配角色：<el-select v-model="selectedId" placeholder="请选择">
                   <el-option
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                editFormRules:{
                    email:[
                        {required: true, validator: "请输入邮箱", trigger: 'blur'},
